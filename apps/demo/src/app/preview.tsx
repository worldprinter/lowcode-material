...
import { ProductComponent } from '@worldprinter/lowcode-material-wdesign'
import type { AssetPackage, CPageDataType } from '@worldprinter/lowcode-model'
import { AssetLoader, collectVariable, flatObject, ReactAdapter, Render, useRender } from '@worldprinter/lowcode-render'
...
export const Preview = () => {
    ...
    const loadPageAssets = async (assets: AssetPackage[]) => {
        ...
        // if (components) {
        setPageComponents(ProductComponent)
        setLoading(false)
        // }
    }
    useEffect(() => {
